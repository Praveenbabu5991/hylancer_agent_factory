    ...
    try:
        ...
        if brand_context:
            ...
            if brand_name:
                base_prompt += f"\nBrand: {brand_name}"
            if brand_colors:
                base_prompt += f"\nBrand colors to incorporate: {', '.join(brand_colors[:3])}"
